...
# Upload CSV file
uploaded_file = st.file_uploader(r"C:\Users\Admin\Downloads\Optimization of bus Ticketing Demand and Forecasting(Data_Set)\Data Set (5)\Operational_Bus_data - Operational_Bus_data.csv", type=["csv"])
